...
<div style="float : right; display:block; margin-right: 20px;">
	<img src="images/series/kanamemo.jpg" border="0">
</div>
<h2>Informations générales</h2>
<h4>Source : <a href="http://animeka.com/fansub/teams/zero.html" target="_blank">Animeka</a></h4>

<p>
<b>Titre Original</b> Kanamemo<br />
<b>Site officiel</b> <a href="http://www.starchild.co.jp/special/kanamemo/" target="_blank">Starchild</a><br />
<b>Année de production</b> 2009<br />
<b>Studio</b> Feel - Starchild Records
<b>Genre</b> Comédie - Déjanté - Ecchi<br />
<b>Auteur</b> Iwami Shouko<br />
<b>Synopsis</b> Kana vient tout juste de perdre sa grand-mère et seule famille, la laissant seule au monde. Après avoir fuit une horde de déménageurs à l'air sournois (du moins pour son petit esprit hermétique à toute réflexion), elle entreprend de chercher un travail, ce qu'elle réussit plus ou moins à trouver au sein d'une petite entreprise de livraison de journaux...<br />
<b>Vosta</b> Underwater
</p>
...
<?php
	...
	$releases = Release::getAllReleasesForProject('kanamemo');
...
<?php
	$releases = Release::getAllReleasesForProject('kanamemobook');
	usort($releases, 'sortReleases');
	$list = new SimpleListComponent();
	$list->setClass("releaseList");
	foreach($releases as $release)
...
<a href="http://tracker.minglong.org/torrents/%5BNipponsei%5D%20Kanamemo%20OP%20Single%20-%20Kimi%20he%20to%20Tsunagu%20Kokoro%20%5BVarious%5D.zip.torrent">[Nipponsei] Kanamemo OP Single - Kimi he to Tsunagu Kokoro [Various].zip</a><br />
</p>

<h2>Images & Wallpaper</h2>
<p>
 <a href="galerie/index.php?spgmGal=Zero_fansub/Images/Kanamemo&amp;spgmPic=0#spgmPicture" class=""><img src="galerie/gal/Zero_fansub/Images/Kanamemo/_thb_[Zero]Kanamemo_Image01.jpg" alt="galerie/gal/Zero_fansub/Images/Kanamemo/_thb_[Zero]Kanamemo_Image01.jpg" class="img-thumbnail" width="150" height="150"></a>    
