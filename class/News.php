...
class News {
	...
	public static function getAllNews() {
		if (News::$allNews === null) {
			...
			$newsMessage->addLine("Et voilà un nouvel opus (ou deux nouveaux obus, au choix) de notre H favori. Enfin je dis favori mais comme c'est moi qui fais la news, je vais avant tout donner mon avis {^_^}.");
			$newsMessage->addLine();
