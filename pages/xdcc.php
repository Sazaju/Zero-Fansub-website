<?php
	...
	$message->addLine();
	$message->addLine();
	$message->addLine("<iframe src='http://sazaju.homelinux.net/zero/lishiantus.txt' width='100%' height='600' frameborder='0'><p>Your browser does not support iframes.</p></iframe>");
?>
