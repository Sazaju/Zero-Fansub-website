<?php
	...
	$corners = null;
	if ($_SESSION[MODE_H]) {
		$corners = CornerImageComponent::getHentaiImages();
	} else {
		$corners = CornerImageComponent::getNotHentaiImages();
	}
	...
	$menu = new Menu();
	$menu->addEntry(new LinkComponent("index.php", "Accueil"));
	$menu->addEntry(LinkComponent::newWindowLink("irc://irc.Fansub-IRC.eu/zero", "IRC"));
	$menu->addEntry(LinkComponent::newWindowLink("http://forum.zerofansub.net", "Forum"));
	$menu->addEntry(LinkComponent::newWindowLink("http://twitter.com/zero_fansub", "Twitter"));
	$radioLink = new LinkComponent("#", "Radio");
	...
	$menu->addEntry(new LinkComponent("index.php?page=xdcc", "XDCC"));
	$leftCol->addComponent(new MenuComponent($menu));
	
	$menu = new Menu();
	$menu->addEntry(new LinkComponent("index.php?page=dossiers", "Dossiers"));
	$menu->addEntry(LinkComponent::newWindowLink("galerie/index.php?spgmGal=Zero_fansub/Images", "Images"));
	$menu->addEntry(LinkComponent::createHentaiAccessLink());
	$leftCol->addComponent(new MenuComponent($menu));
	...
	*/
	...
	$menu->addEntry(LinkComponent::newWindowLink("http://forum.zerofansub.net/t552.htm#p32300", "En savoir +"));
	$leftCol->addComponent(new MenuComponent($menu));
