...
class Release {
	...
	public static function getAllReleases() {
		if (Release::$allReleases === null) {
			...
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_01_[BD_Hi10-1080p]_[B3DA7EFA].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_02_[BD_Hi10-1080p]_[D33B3374].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_03_[BD_Hi10-1080p]_[1F2E37B8].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_04_[BD_Hi10-1080p]_[9990E76F].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_05_[BD_Hi10-1080p]_[C39453C6].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_06_[BD_Hi10-1080p]_[23C880A2].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_07_[BD_Hi10-1080p]_[6E37516B].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_08_[BD_Hi10-1080p]_[713811DE].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_09_[BD_Hi10-1080p]_[502374F0].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi1-10.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_10_[BD_Hi10-1080p]_[46ED12E9].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_11_[BD_Hi10-1080p]_[92B7DE23].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			//$release->setHeaderImage("images/sorties/mayoi11-12.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]_Mayoi_Neko_Overrun!_[BD_Hi10-1080p]/[Zero]_Mayoi_Neko_Overrun!_12_[BD_Hi10-1080p]_[FE3B3FA0].mkv");
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mkv);
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_02_[Hi10-720p][36CC4680].mkv");
			$descriptor->setCRC("36CC4680");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_03_[Hi10-720p][D9237AE3].mkv");
			$descriptor->setCRC("D9237AE3");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_05_[Hi10-720p][AC9635FE].mkv");
			$descriptor->setCRC("AC9635FE");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_06_[Hi10-720p][DF8928E7].mkv");
			$descriptor->setCRC("DF8928E7");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_07_[Hi10-720p][7E41031A].mkv");
			$descriptor->setCRC("7E41031A");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_09_[Hi10-720p][3E1E116E].mkv");
			$descriptor->setCRC("3E1E116E");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_10_[Hi10-720p][7A638808].mkv");
			$descriptor->setCRC("7A638808");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_11_[Hi10-720p][AFBED7C3].mkv");
			$descriptor->setCRC("AFBED7C3");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$release->setComment("Pas de FHD car les blu-ray sont des upscale.");
			$descriptor = new ReleaseFileDescriptor("[Zero]Genshiken_2[Hi10-720p]/[Zero]_Genshiken2_12_[Hi10-720p][79C7D83F].mkv");
			$descriptor->setCRC("79C7D83F");
			$descriptor->setContainerCodec($mkv);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(0);
			Release::$allReleases[] = $release;
			...
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_01[BD][8bits-720p][274B8DF2].mp4");
			...
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_01[BD][10bits-1080p][9D523984].mp4");
			...
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_02[BD][8bits-720p][29A4CBD5].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_02[BD][10bits-1080p][756902E5].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_03[BD][8bits-720p][7D2ECC41].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_03[BD][10bits-1080p][109A867F].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_04[BD][8bits-720p][1733BFA5].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_04[BD][10bits-1080p][4C93316E].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$release->setHeaderImage("images/sorties/denpa4-5.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_05[BD][8bits-720p][AAF431E3].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_05[BD][10bits-1080p][6C28F74C].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_06[BD][8bits-720p][A9E18C25].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_06[BD][10bits-1080p][3B848669].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(strtotime('2 June 2013 11:54'));
			Release::$allReleases[] = $release;
			...
			$release->setHeaderImage("images/sorties/denpa6-9.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_07[BD][8bits-720p][F2C372F2].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_07[BD][10bits-1080p][57CD9079].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$release->setHeaderImage("images/sorties/denpa6-9.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_08[BD][8bits-720p][86E7B968].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_08[BD][10bits-1080p][9485B651].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$release->setHeaderImage("images/sorties/denpa6-9.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_09[BD][8bits-720p][ED4B9B4D].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_09[BD][10bits-1080p][63115B36].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$release->setHeaderImage("images/sorties/denpa10-13.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_10[BD][8bits-720p][8521C8F5].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_10[BD][10bits-1080p][09058A38].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$release->setReleasingTime(strtotime('2013-08-15 19:12'));
			Release::$allReleases[] = $release;
			...
			$release->setHeaderImage("images/sorties/denpa10-13.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_11[BD][8bits-720p][86C47A81].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_11[BD][10bits-1080p][83ADF7CF].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$release->setHeaderImage("images/sorties/denpa10-13.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_12[BD][8bits-720p][B842C177].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_12[BD][10bits-1080p][E75747C3].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$release->setHeaderImage("images/sorties/denpa10-13.png");
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_13[BD][8bits-720p][DA1091E8].mp4");
			$descriptor->setID('8 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			$descriptor->setContainerCodec($mp4);
			$release->addFileDescriptor($descriptor);
			$descriptor = new ReleaseFileDescriptor("[Zero]Denpa_Onna_to_Seishun_Otoko[BD]/[Zero]Denpa_Onna_to_Seishun_Otoko_13[BD][10bits-1080p][8FA3E66E].mp4");
			$descriptor->setID('10 bits');
			$descriptor->setReleaseSource($bd);
			$descriptor->setVideoCodec($h264);
			$descriptor->setSoundCodec($aac);
			...
			$release = new Release(Project::getProject("haganainext"), "ep1");
			$release->setName("01");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep2");
			$release->setName("02");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep3");
			$release->setName("03");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep4");
			$release->setName("04");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep5");
			$release->setName("05");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep6");
			$release->setName("06");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep7");
			$release->setName("07");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep8");
			$release->setName("08");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep9");
			$release->setName("09");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep10");
			$release->setName("10");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep11");
			$release->setName("11");
			Release::$allReleases[] = $release;
			
			$release = new Release(Project::getProject("haganainext"), "ep12");
			$release->setName("12");
			Release::$allReleases[] = $release;
		}
