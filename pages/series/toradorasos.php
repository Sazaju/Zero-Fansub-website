...
<b>Synopsis</b> Ami, Taiga et Ryuuji décident d'aller chez Jonny's pour y gouter les spaghettis Tarako. Sur place ils retrouvent Minori et la dégustation culinaire vire au duel... <br />
</p>
...
for ($i = 1; $i <= 5; $i++)
{
  $file = "episodes/toradorasos" . $i . ".php";
  if (file_exists($file))
    require_once($file);
}
?>
