<h3>Faisons l'amour ensemble !</h3>


<div style="float : right; display:block; margin-right: 20px;">
	<img src="images/series/hshiyo.jpg" border="0">
</div>
<h2>Informations générales</h2>
<h4>Source : <a href="http://animeka.com/fansub/teams/zero.html" target="_blank">Animeka</a></h4>

<p>
<b>Titre Original</b> Issho ni H shiyo<br />
<b>Année de production</b> 2009<br />
<b>Genre</b> Hentaï<br />
<b>Synopsis</b> Vous avez aimez L'entraînement avec Hinako ? Vous aimerez sûrement sa parodie Hentaï, "faisons l'amour ensemble" ! Aujourd'hui, c'est avec vous que notre jolie héroïne fait l'amour... Vous, et vous seul ! Profitez-en ;)<br />
...
<?php
	...
	$releases = Release::getAllReleasesForProject('hshiyo');
...
<a href="index.php?page=series/akinahshiyo"><img src="images/series/akinahshiyo.png" border="0" alt="Akina To Onsen De H Shiyo"></a><br /><br /> 
</p>
