...
Bien que certains d'entre nous soient pour, ce n'est pas le cas de toutes la team, et il est important que chacun y trouve son compte. Désormais, on prévoit de faire toutes nos sorties en [i]softsub[/i], chacun pouvant donc désactiver nos sous-titres et même les extraires sans problèmes. Cependant, ça ne veut pas dire qu'on doive aussi fournir nos anciens sous-titres, et pour l'instant on n'en a pas l'intention.
